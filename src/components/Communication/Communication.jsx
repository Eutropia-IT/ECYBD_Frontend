export default function Communication() {
    return <div style={{ backgroundColor: "#F3F3F3" }}>
        ...
        <h1 className="text-2xl md:text-4xl font-extrabold text-center underline underline-offset-4 decoration-4 decoration-red-600" style={{ color: "#18299D" }}>Executive & Commission Members</h1>
