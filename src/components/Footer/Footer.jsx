...
const Footer = () => {
    return (
        <div className='' style={{ backgroundColor: "#FEE6F4" }}>
            <svg width="full" height="75" viewBox="0 0 1920 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* <footer className="footer p-10  px-32" style={{ backgroundColor: "#FEE6F4" }}>
                <div>
                    ...
                    <div>
                        <h5 className='font-bold mt-6'>Follow us on social media</h5>
                        <div className='grid grid-cols-3 w-4/6 mt-4'>
                            <a> <img className='w-3/6 cursor-pointer' src={"https://i.ibb.co/WycqD3t/facebook.png"} alt="" /></a>
                            <a> <img className='w-3/6 cursor-pointer' src={"https://i.ibb.co/KDNJ8TJ/twitter.png"} alt="" /></a>
                            <a> <img className='w-3/6 cursor-pointer' src={"https://i.ibb.co/KDNJ8TJ/twitter.png"} alt="" /></a>
